...
sweep_name = "delta-net-v0" + sweep_id
...
from zoology.experiments.models_repo import add_attention, add_based, add_mamba2, add_rwkv7, add_delta_net
# models = add_attention(models)
# models = add_based(models)
# models = add_mamba2(models)
