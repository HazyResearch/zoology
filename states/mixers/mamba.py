...
from states.mixers.mamba_ssm.triton.layernorm import RMSNorm, layer_norm_fn, rms_norm_fn
try:
    from causal_conv1d import causal_conv1d_fn
except:
    assert 0, print(f"Need to install causal_conv1d: pip install causal_conv1d")
try:
    from states.mixers.mamba_ssm.selective_scan_interface import selective_scan_fn, mamba_inner_fn
except:
...
class MambaBlock(nn.Module):
    def __init__(
        ...
        from states.mixers.mamba_ssm.triton.layernorm import RMSNorm
